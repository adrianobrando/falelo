	...
	<footer class="footer-wrapper" >
		...
		<div class="copyright-wrapper">
			<div class="copyright-container container">
				<?php
					if( !empty($theme_option['copyright-social']) && $theme_option['copyright-social'] != 'none' ){
						echo '<div class="copyright-social-wrapper">';
						gdlr_print_header_social($theme_option['copyright-social']);
						echo '</div>';
					}
				?>
