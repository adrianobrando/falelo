			...
			$title = array(
				'title-type'=> array(	
					...
					'options'=> array(
						...
						'left-small'=> __('Left Align (Small)' ,'gdlr_translate'),
						'center'=> __('Center Align' ,'gdlr_translate'),
						'center-small'=> __('Center Align (Small)' ,'gdlr_translate'),
					)
				),										
				'title'=> array(	
					'title'=> __('Title' ,'gdlr_translate'),
					'type'=> 'text',
					'wrapper-class'=>'title-type-wrapper left-wrapper center-wrapper left-small-wrapper center-small-wrapper'
				),			
				'caption'=> array(	
					...
					array(
						...
						'content-item' => array(
							...
							'options' => array(
								...
								'column-service' => array(
									...
									'options'=>array(
										...
										'style'=> array(
											...
											'type'=> 'combobox',
											'options'=> array(
												'type-3'=> __('Main Style' ,'gdlr_translate'),	
												'type-3-featured'=> __('Main Style Featured' ,'gdlr_translate'),	
												'type-1'=> __('Style 1' ,'gdlr_translate'),	
												'type-2'=> __('Style 2' ,'gdlr_translate'),	
											)
										),			
										'featured-background'=> array(
											'title'=> __('Feature Background' ,'gdlr_translate'),
											'type'=> 'colorpicker',
											'default'=> '#ef5597',
											'wrapper-class'=> 'style-wrapper type-3-featured-wrapper'
										),									
										'content'=> array(
											'title'=> __('Content Text' ,'gdlr_translate'),
											'type'=> 'tinymce',						
										...
										'learn-more-text'=> array(
											'title'=> __('Learn More Text' ,'gdlr_translate'),
											'type'=> 'text',
								...
								'feature-media' => array(
									...
									'options'=> array_merge(array(
										...
										'align'=> array(
											'title'=> __('Alignment' ,'gdlr_translate'),
											'type'=> 'combobox',
											'options'=> array(
												'left' => __('Left' ,'gdlr_translate'),
							...
							'page'=> array(
								...
								'quote' => array(
									'title'=> __('Quote', 'gdlr_translate'), 
									'type'=>'item',
									'options'=>array(
										'author'=> array(	
											'title' => __('Author', 'gdlr_translate'),
											'type'=> 'text'
										),
										'position'=> array(	
											'title' => __('Position', 'gdlr_translate'),
											'type'=> 'text'
										),
										'content'=> array(	
											'title' => __('Content', 'gdlr_translate'),
								...
								'testimonial' => array(
									...
									'options'=> array_merge(array(
										...
										'testimonial-style'=> array(
											...
											'type'=> 'combobox',
											'options'=> array(
												'widget-style'=>__('Widget Style', 'gdlr_translate'),
