	...
	if( !function_exists('gdlr_generate_style_custom') ){
		function gdlr_generate_style_custom( $options ){
			...
			foreach($skins as $skin){
				...
				$style .= '#class# .portfolio-title, #class# .portfolio-title a, #class# .portfolio-title a:hover{ color: ' . $skin['port-title'] . '; }' . "\n"; 
				...
				$style .= '#class# .gdlr-skin-box, #class# .gdlr-column-service-item .gdlr-skin-box{ background-color: ' . $skin['element-background'] . '; }' . "\n"; 
				$style .= '#class# .gdlra-skin-box{ background: ' . $skin['element-background'] . '; background: rgba(' . gdlr_convert_rgba($skin['element-background']) . ', 0.75); }' . "\n"; 
									...
									'options' => array(
										...
										'boxed-style-frame' => array(
											...
											'selector' => '.body-wrapper.gdlr-boxed-style{ max-width: #gdlr#; overflow: hidden; } ' .
												'.body-wrapper.gdlr-boxed-style .gdlr-header-wrapper{ max-width: 100%; width: #gdlr#; margin: 0px auto; }', 
							...
							'options' => array(
								...
								'header-logo' => array(
									...
									'options' => array(								
										...
										'logo-id' => array(
											'title' => __('Upload Header Logo', 'gdlr_translate'),
								...
								'copyright' => array(
									...
									'options' => array(		
										'copyright-social' => array(
											'title' => __('Top Bar Social on Copyright', 'gdlr_translate'),
											'type' => 'combobox',
											'options' => array(
										...
										'copyright-left-text' => array(
											'title' => __('Copyright 1 Text', 'gdlr_translate'),
											'type' => 'textarea',	
											'class' => 'full-width',
										),		
										'copyright-right-text' => array(
											'title' => __('Copyright 2 Text', 'gdlr_translate'),
											'type' => 'textarea',	
											'class' => 'full-width',
										),											
									)					
						...
						'elements-color' => array(
							...
							'options' => array(
								...
								'skin-settings' => array(
									...
									'options' => array(
											...
											'options' => array(
												...
												'port-title'=>__('Port Title Color', 'gdlr_translate'),
								...
								'top-bar-color' => array(
									...
									'options' => array(						
										...
										'header-background-color' => array(
											...
											'data-type' => 'rgba',
											'default' => '#ffffff',
											'selector'=> '.gdlr-header-inner{ background-color: rgba(#gdlra#, 0.85); }'
								...
								'main-navigation-color' => array(
									'title' => __('Main Menu', 'gdlr_translate'),
									'options' => array(
								...
								'blog-color' => array(
									...
									'options' => array(
										'blog-date-text' => array(
											'title' => __('Blog Date Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#5f5f5f',
											'selector'=> '.gdlr-blog-date-wrapper{ color: #gdlr#; }'
										),
										'blog-date-bottom-border' => array(
											'title' => __('Blog Date Bottom Border', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#639edb',
											'selector'=> '.gdlr-blog-date-wrapper{ border-color: #gdlr#; }'
										),
								...
								'portfolio-color' => array(
									...
									'options' => array(
										...
										'portfolio-filter-button-active-text' => array(
											'title' => __('Portfolio Filter Active Button Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#639edb',
										...
										'portfolio-title-color' => array(
											...
											'selector'=> '.portfolio-title a{ color: #gdlr#; }' . 
												'.gdlr-classic2-portfolio .portfolio-title{ border-color: #gdlr#; }'
										),
										...
										'portfolio-title-background' => array(
											'title' => __('Portfolio Title Background ( Classic Style 1 )', 'gdlr_translate'),
											'type' => 'colorpicker',
											'data-type' => 'rgba',
											'default' => '#f5f5f5',
											'selector'=> '.gdlr-classic-portfolio .portfolio-title{ background: #gdlr#; background: rgba(#gdlra#, 0.75); }'
										),										
										'portfolio-price-color' => array(
											'title' => __('Portfolio Price', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#639edb',
											'selector'=> '.portfolio-title .gdlr-port-price{ color: #gdlr#; }'
										),
										'portfolio-info-head-color' => array(
											'title' => __('Portfolio Info Head', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#707070',
											'selector'=> '.portfolio-info .info-head{ color: #gdlr#; }'
										),
										'portfolio-info-color' => array(
											'title' => __('Portfolio Info', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#848484',
											'selector'=> '.portfolio-info, .portfolio-info a{ color: #gdlr#; }'
										),
								...
								'personnel-testimonial-color' => array(
									...
									'options' => array(
										'personnel-thumbnail-border' => array(
											'title' => __('Personnel Thumbnail Border', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#eb639c',
											'selector'=> '.gdlr-personnel-item .gdlr-personnel-thumbnail{ border-color: #gdlr#; }'
										),	
										'personnel-hover-background' => array(
											'title' => __('Personnel Hover Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f5f5f5',
											'selector'=> '.gdlr-personnel-item:hover{ background-color: #gdlr#; }'
										),									
										'personnel-title-color' => array(
											'title' => __('Personnel Title Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#3e3e3e',
											'selector'=> '.gdlr-personnel-item .personnel-title a{ color: #gdlr#; }'
										),	
										...
										'personnel-social-divider' => array(
											'title' => __('Personnel Social Divider', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#d8d8d8',
											'selector'=> '.gdlr-personnel-item .personnel-social-divider{ border-color: #gdlr#; }'
										),	
										...
										'personnel-button-background' => array(
											'title' => __('Personnel Button Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#eb639c',
											'selector'=> '.gdlr-personnel-item .gdlr-personnel-read-more{ background-color: #gdlr#; }'
										),			
								...
								'slider-input-color' => array(
									...
									'options' => array(
										...
										'slider-outer-nav-background' => array(
											...
											'data-type' => 'rgba',
											'default' => '#eeeeee',
											'selector'=> '.gdlr-item-title-wrapper .gdlr-flex-prev, .gdlr-item-title-wrapper .gdlr-flex-next{ background: #gdlr#; background: rgba(#gdlra#, 0.75); }',
								...
								'footer-color' => array(
									...
									'options' => array(
										...
										'gdlr-copyright1-text-color' => array(
											'title' => __('Copyright 1 Text Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#9d9d9d',
											'selector'=> '.copyright-wrapper .copyright-left{ color: #gdlr#; }'
										),
										'gdlr-copyright2-text-color' => array(
											'title' => __('Copyright 2 Text Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#6d6d6d',
											'selector'=> '.copyright-wrapper .copyright-right{ color: #gdlr#; }'
										),
