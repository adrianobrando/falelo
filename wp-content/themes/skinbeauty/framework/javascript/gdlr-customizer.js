...
{name: "header-background-color", selector: ".gdlr-header-inner{ background-color: rgba(#gdlra#, 0.85); }"},
...
{name: "search-box-text-color", selector: ".gdlr-menu-search input[type=\"text\"]{ color: #gdlr#; }"},
...
{name: "blog-date-text", selector: ".gdlr-blog-date-wrapper{ color: #gdlr#; }"},
{name: "blog-date-bottom-border", selector: ".gdlr-blog-date-wrapper{ border-color: #gdlr#; }"},
...
{name: "portfolio-filter-button-active-text", selector: ".portfolio-item-filter a:hover, .portfolio-item-filter a.active{ color: #gdlr#; }"},
...
{name: "portfolio-title-color", selector: ".portfolio-title a{ color: #gdlr#; }.gdlr-classic2-portfolio .portfolio-title{ border-color: #gdlr#; }"},
{name: "portfolio-title-hover-color", selector: ".portfolio-title a:hover{ color: #gdlr#; }"},
{name: "portfolio-title-background", selector: ".gdlr-classic-portfolio .portfolio-title{ background: #gdlr#; background: rgba(#gdlra#, 0.75); }"},
{name: "portfolio-price-color", selector: ".portfolio-title .gdlr-port-price{ color: #gdlr#; }"},
{name: "portfolio-info-head-color", selector: ".portfolio-info .info-head{ color: #gdlr#; }"},
...
{name: "personnel-thumbnail-border", selector: ".gdlr-personnel-item .gdlr-personnel-thumbnail{ border-color: #gdlr#; }"},
{name: "personnel-hover-background", selector: ".gdlr-personnel-item:hover{ background-color: #gdlr#; }"},
{name: "personnel-title-color", selector: ".gdlr-personnel-item .personnel-title a{ color: #gdlr#; }"},
{name: "personnel-position-color", selector: ".gdlr-personnel-item .personnel-position{ color: #gdlr#; }"},
{name: "personnel-social-divider", selector: ".gdlr-personnel-item .personnel-social-divider{ border-color: #gdlr#; }"},
{name: "personnel-social-icon-color", selector: ".gdlr-personnel-item .personnel-social i{ color: #gdlr#; }"},
{name: "personnel-button-background", selector: ".gdlr-personnel-item .gdlr-personnel-read-more{ background-color: #gdlr#; }"},
...
{name: "slider-outer-nav-background", selector: ".gdlr-item-title-wrapper .gdlr-flex-prev, .gdlr-item-title-wrapper .gdlr-flex-next{ background: #gdlr#; background: rgba(#gdlra#, 0.75); }"},
...
{name: "gdlr-copyright1-text-color", selector: ".copyright-wrapper .copyright-left{ color: #gdlr#; }"},
{name: "gdlr-copyright2-text-color", selector: ".copyright-wrapper .copyright-right{ color: #gdlr#; }"},
