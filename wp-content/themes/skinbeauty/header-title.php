...
?>
	...
	<?php $page_background = ''; ?>
		<div class="gdlr-page-title-wrapper" <?php echo empty($header_background)? '': 'style="background-image: url(\'' . esc_url($header_background) . '\'); "'; ?> >
			...
			<div class="gdlr-page-title-container container" >
				...
				<span class="gdlr-page-caption gdlr-title-font"><?php echo gdlr_text_filter(gdlr_escape_string($gdlr_post_option['page-caption'])); ?></span>
				<?php } ?>
			</div>	
		</div>	
	...
	?>
		<div class="gdlr-page-title-wrapper" <?php echo empty($header_background)? '': 'style="background-image: url(\'' . esc_url($header_background) . '\'); "'; ?> >
			...
			<div class="gdlr-page-title-container container" >
				...
				<span class="gdlr-page-caption gdlr-title-font"><?php echo gdlr_text_filter(gdlr_escape_string($page_caption)); ?></span>
				<?php } ?>
			</div>	
		</div>	
	<?php }else if( is_single() ){ // for custom post type
		...
		if( get_post_type() == 'personnel' ){
			$page_caption = $gdlr_post_option['position'];
		}else if( !empty($gdlr_post_option) && !empty($gdlr_post_option['page-caption']) ){
			$page_caption = $gdlr_post_option['page-caption'];
	...
	?>
		<div class="gdlr-page-title-wrapper" <?php echo empty($header_background)? '': 'style="background-image: url(\'' . esc_url($header_background) . '\'); "'; ?> >
			...
			<div class="gdlr-page-title-container container" >
				...
				<h1 class="gdlr-page-caption gdlr-title-font"><?php echo gdlr_text_filter(gdlr_escape_string($caption)); ?></h1>
				<?php } ?>
			</div>	
		</div>		
	<?php } ?>
