...
class WC_PDF_Product_Vouchers_Email_Voucher_Recipient extends WC_Email {
	...
	public function __construct() {
		...
		$this->heading     = __( 'You have received a voucher', 'woocommerce-pdf-product-vouchers' );
		$this->subject     = __( 'You have received a voucher from {purchaser_name}', 'woocommerce-pdf-product-vouchers' );
