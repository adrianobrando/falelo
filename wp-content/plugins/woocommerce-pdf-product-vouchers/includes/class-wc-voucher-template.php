...
class WC_Voucher_Template extends WC_Voucher_Base {
	...
	public function get_additional_image_id() {
		 ...
		 * @param \WC_Voucher_Template $voucher_template voucher template object
		 */
		return apply_filters( 'wc_pdf_product_vouchers_voucher_template_additional_image_id', $image_id, $this );
	}
	...
	public function get_logo_id() {
		 ...
		 * @param \WC_Voucher_Template $voucher_template voucher template object
		 */
		return apply_filters( 'wc_pdf_product_vouchers_voucher_template_logo_image_id', $logo_id, $this );
	}
	...
	/**
	 * Returns img tags of all the available images for this voucher template
	 *
	...
	public function get_dpi() {
		 ...
		 */
		return apply_filters( 'wc_pdf_product_vouchers_voucher_image_dpi', $dpi, $this );
	}
