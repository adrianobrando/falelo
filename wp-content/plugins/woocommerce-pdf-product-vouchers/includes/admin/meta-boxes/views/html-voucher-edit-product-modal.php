			...
			<section class="wc-backbone-modal-main" role="main">
				...
				<article>
					<form action="" method="post">
						...
						<p>
							<label for="voucher_product_price"><?php esc_html_e( 'Price (voucher value)' ); ?></label>
							<input type="text"   id="voucher_product_price" name="product_price" class="wc_input_price" placeholder="<?php echo wc_format_localized_price( 0 ); ?>" style="width: 100%;" value="{{{data.product_price}}}" />
						</p>
					</form>
				</article>
				<footer>
