						...
						<div id="portfolio-<?php the_ID(); ?>" <?php post_class(); ?>>
							...
							<div class="gdlr-portfolio-content">
								<div class="gdlr-portfolio-info">
									<h4 class="head"><?php echo __('Informazioni', 'gdlr-portfolio'); ?></h4>
									...
									<div class="content">
									<?php 
										echo gdlr_get_portfolio_info(array('time', 'staff', 'price', 'tag', 'brochure'), $gdlr_post_option, false); 
										gdlr_get_social_shares();
									?>							
									</div>
								</div>								
								<div class="gdlr-portfolio-description">
									<h4 class="head"><?php echo __('Dettagli prodotto', 'gdlr-portfolio'); ?></h4>
									<div class="content">
									<?php 
										the_content(); 
										wp_link_pages( array( 
					...
					<?php
						...
						if( !$gdlr_is_ajax && is_single() && $theme_option['portfolio-related'] == 'enable' ){	
							...
							if( $query->have_posts() ){
								...
								echo '<h4 class="head">' . __('Ti potrebbe interessare', 'gdlr-portfolio') . '</h4>';
